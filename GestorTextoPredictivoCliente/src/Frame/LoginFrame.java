...
public class LoginFrame extends javax.swing.JDialog {
     ...
     * @param protocolo
     */
    public LoginFrame(java.awt.Frame parent, boolean modal, ProtocoloConexion protocolo) {
        super(parent, modal);
        initComponents();
        ...
        KeyListenerImpl listener = new KeyListenerImpl(fieldNombre, this.fieldApellidos, this.fieldMail1, this.fieldMail2);

        fieldNombre.addKeyListener(listener);
        fieldApellidos.addKeyListener(listener);
        fieldMail1.addKeyListener(listener);
        fieldMail2.addKeyListener(listener);
    }
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(fieldApellidos, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        this.protocolo.enviarMensaje(9, this.fieldNombre.getText() + "#" + this.fieldApellidos.getText() + "#" + this.fieldMail1.getText());
        this.dispose();
    ...
    private class KeyListenerImpl implements KeyListener {
        ...
        public KeyListenerImpl(JTextField nombre, JTextField app, JTextField mail1, JTextField mail2) {
            this.nombre = nombre;
            this.app = app;
            this.mail1 = mail1;
            this.mail2 = mail2;
